...
export function Cta() {
    return (
        <section className="py-12 md:py-24 bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 relative overflow-hidden">
            {/* Decorative Elements */}
            <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary rounded-none blur-3xl" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary rounded-none blur-3xl" />
            </div>

            <div className="relative z-10 container mx-auto px-4">
                <div className="py-16 md:py-24 px-8 md:px-12">
                    <div className="max-w-4xl mx-auto text-center">
                        {/* Badge */}
                        <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-none text-sm font-bold uppercase tracking-widest mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            ...
                            >
                                <div className="w-14 h-14 rounded-none bg-white/10 flex items-center justify-center">
